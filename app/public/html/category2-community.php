                        ...
                        <div class="table-nav">
                            <div class="nav-list">
                                ...
                                <ul style="margin-top: .5rem;">
                                    <input    type="submit" name="counseling" class="nav-choice"value="COUNSELING" style="border-bottom: solid 3px rgb(98, 130, 172)">
                                    </input>
                                    <input type="submit" name="community" class="nav-choice" id="service" value="COMMUNITY SERVICE">
                                    </input>
                                </ul>
                            </div>
                        </div>
                    ...
                    <hr>
                        ...
                        <div class="violation-container1">
                            <div class="multi-left">
                                ...
                                <div class="input-wrap">
                                    <label for="department" style="min-width: 200px; display: none" class="department-function">Specify Department:</label>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="buttons">
        <input type="submit" name="send_email" id="add_violation" value="Send Email">
        <input type="submit" name="send_email" id="add_violation" value="Print Violation">
      </div>
      <div>
        <p>Email sent</p>
      </div>
...
Violation Committed: ${$('#violation_type option:selected').text()}
