  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="offense">
                                    ...
                                    <p style="color: rgb(220, 53, 69);" id="offense_error" hidden>Please select offense above.</p>

                                    <label for="violation_type">Violation Type:</label>
                                    <select id="violation_type" name="violation_type" disabled>
                                    <option value="" style="display: none;">Select Violation</option>
                                    </select>
                                    <p style="color: rgb(220, 53, 69);" id="violation_error" hidden>Please select offense above.</p>
                                </div>
                                ...
                                <p style="color: rgb(220, 53, 69);" id="description_error" hidden>Please fill up the description.</p>
      </div>
